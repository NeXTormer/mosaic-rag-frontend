...
import '../widgets/standard_elements/frederic_card.dart';
          ...
          return Column(
            ...
            children: [
              if (false)
                CurlieSelector(
                  labels: [
                    'Phones/iPhone/iPhone 13',
                    'Phones/iPhone/iPhone 14',
                    'Phones/Google/Pixel 8',
                    'Phones/Google/Pixel 9',
                    'Phones/Google/Pixel 9'
                  ],
                ),
              Expanded(
                child: CustomScrollView(
                  ...
                  slivers: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FredericDropDownTextField(
                                        ...
                                        controller:
                                            columnSelectorTextFieldController,
                                        suggestedValues:
                    ...
                    if (taskState is TaskFinished)
                      SliverToBoxAdapter(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              color: theme.greyTextColor, fontSize: 11),
                        ),
                      )),
                    if (taskState is TaskFinished)
                      SliverPadding(
                    ...
                    if (taskState is TaskFinished &&
                        taskState.taskInfo.data.isEmpty)
                      SliverToBoxAdapter(
                        child: Padding(
                          padding: const EdgeInsets.only(top: 200),
                          child: Center(
